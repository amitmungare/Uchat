...
import com.example.uchat.utils.KeyboardVisibilityUtil
import com.example.uchat.utils.isSameDayAs
...
class ChatsAvt : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_chats_avt)
    ...
    companion object {
        ...
        fun createChatActivity(context: Context, id: String, name: String, image: String): Intent {
            val intent = Intent(context, ChatsAvt::class.java)
